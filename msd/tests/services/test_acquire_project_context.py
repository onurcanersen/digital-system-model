...
def test_execute_returns_context_when_explicit_ids_match():
    ...
    result = AcquireProjectContext(repo).execute(
...
def test_execute_marks_missing_data_when_project_id_not_specified():
    ...
    result = AcquireProjectContext(repo).execute(platform_id="plat-1", version_id="1.0.0")
...
def test_execute_marks_missing_data_when_platform_id_not_specified():
    ...
    result = AcquireProjectContext(repo).execute(project_id="proj-1", version_id="1.0.0")
...
def test_execute_marks_missing_data_when_version_id_not_specified():
    ...
    result = AcquireProjectContext(repo).execute(project_id="proj-1", platform_id="plat-1")
